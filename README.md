...
This bar chart compares the total sales generated by each product category. Technology has the highest total sales among all categories.
...
This histogram shows how sales values are distributed across the dataset. It helps identify the common sales range and extreme values.

<img width="780" height="527" alt="image" src="https://github.com/user-attachments/assets/88d8bccc-6e84-4207-a2a8-0890be076e1b" />

3. Profit by Category – Bar Plot

This bar plot compares the average profit across different categories. It helps identify which category performs better in terms of profitability.

<img width="671" height="497" alt="image" src="https://github.com/user-attachments/assets/f6610a7b-c13e-463a-8000-4fef3673d134" />

4. Sales Distribution by Category – Bar Plot

This bar plot compares the average sales value across different categories. It provides a clear view of category-wise sales performance.

<img width="688" height="486" alt="image" src="https://github.com/user-attachments/assets/a38f323d-5b55-4b4c-a40d-2421393a6fe3" />

5.Profit Distribution – Box Plot

This boxplot shows the overall distribution and variation of profit values. It also helps identify negative profits and extreme outliers.

<img width="695" height="437" alt="image" src="https://github.com/user-attachments/assets/1e9dfc81-e3f6-4bcf-b3da-f74236a10f32" />

6. Profit Variation Across Categories – Box Plot

This boxplot compares profit variation among different categories. It shows the spread, median, and outliers of profit for each category.

<img width="755" height="467" alt="image" src="https://github.com/user-attachments/assets/2865b1de-0fab-49df-8d1b-f8062b04f580" />

7. Discount vs Profit – Scatter Plot

This scatter plot shows the relationship between discount and profit. The negative correlation suggests that higher discounts are generally associated with lower profit.

<img width="672" height="480" alt="image" src="https://github.com/user-attachments/assets/855464f4-7863-4f08-aa83-81523f49a630" />

8. Correlation Heatmap

This heatmap displays the correlation between numerical variables in the dataset. It helps identify positive and negative relationships between Sales, Profit, Discount, Quantity, and Delivery Days.
